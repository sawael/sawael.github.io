!(function () {
  ...
  if (
    (s(function () {
      ...
      function s(e) {
        setTimeout(function () {
          r(e, ".sae-parallax-background").forEach(function (e) {
            jarallax &&
      ...
      if (
        ...
        window.addEventListener("scroll", function () {
          document
            .querySelectorAll(".sae-navbar--sticky")
            .forEach(function (e) {
              var t = window.scrollTop > 10 ? "add" : "remove";
              e.classList[t]("sae-navbar--stuck"),
                e.classList.contains(".sae-navbar--open") ||
                  e.classList[t]("sae-navbar--short");
            });
        }),
          ...
          ? (function (e, t) {
              ...
              (n[t > e ? 0 : 1] = t),
                window.smartresize(function () {
                  ...
                  var t = document.querySelector(".sae-section--full-height");
                  t && (t.style.height = e + "px");
                });
            })(window.innerWidth, window.innerHeight)
          : u ||
            (window.smartresize(function () {
              var e = document.querySelector(".sae-section--full-height");
              e && (e.style.height = window.innerHeight + "px");
            }),
            document.addEventListener("add.cards", function (e) {
              document
                .querySelector("html")
                .classList.contains("sae-site-loaded") &&
                r(e.target, ".sae-section--full-height").length &&
                window.dispatchEvent(new CustomEvent("resize"));
            })),
        window.addEventListener("smartresize", function () {
          document.querySelectorAll(".sae-section--16by9").forEach(n);
        }),
        o &&
          e(document).on("add.cards changeParameter.cards", function (e) {
            var t = r(e.target, ".sae-section--16by9");
            t.length
        ...
        if (
          (window.addEventListener("update.parallax", function (e) {
            setTimeout(function () {
              if (e) {
                var e = document.querySelector(".sae-parallax-background");
            ...
            e(document).on("changeParameter.cards", function (t, n, o, r) {
              if ("bg" === n)
                switch (
                  ...
                  (i.style.position = ""),
                  e(t.target).find(".sae-background-video-preview").remove(),
                  e(t.target).find(".sae-background-video").remove(),
                  r)
                ) {
                  case "type":
                  case "parallax":
      ...
      function g(e) {
        r(e, "[data-bg-video]").forEach(function (e) {
          ...
          var o = new URLSearchParams(n),
            ...
            a =
              e.querySelector(".sae-background-video-preview") ||
              document.createElement("div");
          a.classList.add("sae-background-video-preview"),
          ...
          if (i && (/youtu\.?be/g.test(i[3]) || /vimeo/g.test(i[3]))) {
              ...
              (s.onload = function () {
                if (120 === (s.naturalWidth || s.width)) {
                  ...
                  (a.style.backgroundImage = 'url("' + s.src + '")'),
                    (a.style.display = "block");
                e.querySelector(".sae-background-video") &&
                  e.querySelector(".sae-background-video").remove();
                var o = document.createElement("div");
                const l = document.createElement("div"),
                  c = document.createElement("div"),
                  d = document.createElement("div");
                d.classList.add("sae-video-foreground"),
                  d.appendChild(o),
                  c.appendChild(d),
                  l.appendChild(c),
                  o.classList.add("sae-background-video");
            ...
            let t = "";
            e.querySelector(".sae-fallback-image") &&
      ...
      if (
          ...
          e(document).on("add.cards delete.cards", function (e) {
            c && clearTimeout(c),
              (c = setTimeout(function () {
                ...
                var e = document.querySelector(".sae-fixed-top");
                e &&
        ...
        window.smartresize(function () {
          document
            .querySelectorAll(".sae-embedded-video")
            .forEach(function (e) {
              e.style.height =
                (
        ...
        e(document).on("add.cards", function (e) {
          e.target !== document &&
            !y.some((t) => t === e.target) &&
            e.target.hasAttribute("sae-data-bg-video") &&
      ...
      t &&
        ...
        document.querySelector("html").classList.add("sae-site-loaded"),
        window.dispatchEvent(new CustomEvent("resize")),
        ...
        document
          .querySelectorAll(".cols-same-height .sae-figure")
          .forEach(function (e) {
    ...
    t ||
      (o &&
        e.fn.socialLikes &&
        e(document).on("add.cards", function (e) {
          r(e.target, ".sae-social-likes").forEach(function (e) {
      ...
      Array.from(document.body.children)
        ...
        .forEach(function (e) {
          e.classList.contains("sae-reveal") &&
        ...
        if (!d() && document.querySelectorAll("input[name=animation]").length) {
          ...
          var e = Array.from(
            document.querySelectorAll(
              "p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .sae-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .sae-figure, .sae-map, .sae-testimonial .card-block, .sae-price-value, .sae-price-figure, .dataTable, .dataTables_info, .item"
            )
          );
          function t() {
          ...
          (e = (e = e.filter(function (e) {
            if (
              !e.parents().filter(function (e) {
                if (
                  e.matches(
                    "a, p, .navbar, .sae-arrow, footer, .iconbox, .sae-slider, .sae-gallery, .sae-testimonial .card-block, #cookiesdirective, .sae-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal, .item"
                  )
                )
                  return !0;
              }).length
    ...
    s(function () {
      if (document.querySelectorAll(".sae-arrow-up").length) {
    ...
    var m = document.querySelector(".sae-arrow");
    m &&
  ...
  if (document.querySelectorAll("nav.navbar").length) {
    ...
    document.querySelector(".sae-after-navbar.sae-fullscreen") &&
      (document.querySelector(
        ".sae-after-navbar.sae-fullscreen"
  ...
  if (
    (!t &&
      ...
      e(document).on("add.cards", function (e) {
        var t = e.target;
        if (t.classList.contains("sae-fullscreen")) {
          var n = function () {
            (t.style.height = "auto"),
        ...
        (t.classList.contains("sae-slider") ||
          t.classList.contains("sae-gallery")) &&
  ...
  if (
    (t ||
            ...
            e.addEventListener("click", function () {
              var t = e.closest(".accordionStyles").getAttribute("id"),
                ...
                o = e.querySelector("span.sign")
                  ...
                  : e.querySelector("span.sae-iconfont");
              if (
      ...
      0 != document.querySelectorAll(".sae-slider.carousel").length &&
        document.querySelectorAll(".sae-slider.carousel").forEach(function (t) {
          var n = t,
